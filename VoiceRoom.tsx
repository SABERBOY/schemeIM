...
export const VoiceRoom = ({ room, user, onLeave, onUpdateUser, lang, t }: VoiceRoomProps) => {
  ...
  return (
    <div style={{
      height: '100dvh', // Explicitly use dynamic viewport height
      width: '100vw', 
      position: 'relative', 
      overflow: 'hidden',
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, #311B92 0%, transparent 60%)',
      ...
      <div style={{
        ...
        backgroundImage: 'radial-gradient(1.5px 1.5px at 20px 30px, white, transparent), radial-gradient(1px 1px at 40px 70px, rgba(255,255,255,0.8), transparent), radial-gradient(2px 2px at 90px 40px, rgba(255,255,255,0.5), transparent)',
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          zIndex: 20, // Ensure header stays clickable
          flexShrink: 0
        }}>
          <div style={{ color: 'white', cursor: 'pointer' }} onClick={onLeave}>
            <Icon name="close" />
          </div>
        ...
        {/* Seats Grid */}
        <div style={{ padding: '20px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '15px', flexShrink: 0 }}>
          {/* Host Seat */}
        ...
        {/* Footer / Controls */}
        <div style={{ padding: '10px', backgroundColor: '#1E1E1E', flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <button 
